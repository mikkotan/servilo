...
app.controller("RestaurantCtrl", ["$scope", "$firebaseArray", "$firebaseAuth", "User", "$ionicModal", "$stateParams",
function($scope, $firebaseArray, $firebaseAuth, User, $ionicModal, $stateParams){
